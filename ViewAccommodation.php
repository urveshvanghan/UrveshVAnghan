...
<h3>See all Student accommodation</h3>
	
		<table>
		
			<tr>
				<th width="250px">Accommodation Id <br><hr></th>
				<th width="250px">Student Id<br><hr></th>
				<th width="250px">Accommodation<br><hr></th>
			...
			*/	
			$sql = mysqli_query($link, "SELECT AccommodationId, StudentId, Accommodation, Membership  FROM Accommodations");
			while ($row = $sql->fetch_assoc()){
			echo "
			<tr>
				<th>{$row['AccommodationId']}</th>
				<th>{$row['StudentId']}</th>
				<th>{$row['Accommodation']}</th>
