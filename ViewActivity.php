...
<h3>See all Students activities</h3>
	
		<table>
		
			<tr>
				<th width="250px">Activitiy Id <br><hr></th>
				<th width="250px">Student Id <br><hr></th>
				<th width="250px">Activity<br><hr></th>
                <th width="250px">Membership<br><hr></th>
                <th width="250px">Schedule<br><hr></th>
			</tr>
			...
			*/	
			$sql = mysqli_query($link, "SELECT ActivitiyId, StudentId, Activity, Membership, Schedule  FROM Activities");
			while ($row = $sql->fetch_assoc()){
			echo "
			<tr>
				<th>{$row['ActivitiyId']}</th>
				<th>{$row['StudentId']}</th>
				<th>{$row['Activity']}</th>
