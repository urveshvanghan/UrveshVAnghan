...
<html>
    ...
    <body>
        ...
        <div>
            <br>
            <form method="post" action="AddAccommodation.php">
              <label>Student:</label>
              ...
              ?>
               ...
               <br><br>
                ...
                <input type="radio" id="Morning" name="Accommodation" value="Morning">
                <label for="Morning">Singal</label>
                <input type="radio" id="Afternoon" name="Accommodation" value="Afternoon">
                <label for="Afternoon">Sharing</label><br><br>
                <label>Membership</label>
                <select id="Membership" name="Membership">
                  <option>Bronze Membership</option>
                  <option>Silver Membership</option>
                  <option>Gold Membereship</option>
                </select><br><br>
